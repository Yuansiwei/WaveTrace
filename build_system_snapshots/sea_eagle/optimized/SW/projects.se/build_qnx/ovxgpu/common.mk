...
PINFO DESCRIPTION="OpenVX GPU kernel libraries"

endef



NAME=libOvxGPUVXCBinary
...
EXTRA_INCVPATH += $(driver_root)/driver/khronos/libOpenVX/libkernel/libovxgpu
...
SOURCE_OBJECTS += $(driver_root)/driver/khronos/libOpenVX/libkernel/libovxgpu/$(GPU_CONFIG)/ovxgpu_vxc_binary_interface.o



EXTRA_SRCVPATH += $(driver_root)/driver/khronos/libOpenVX/libkernel/libovxgpu

EXTRA_SRCVPATH += $(driver_root)/driver/khronos/libOpenVX/libkernel/libovxgpu/$(GPU_CONFIG)
