...
SOURCE_OBJECTS += $(driver_root)/compiler/libVSC/old_impl/gc_vsc_old_preprocess.o
...
SOURCE_OBJECTS += $(driver_root)/compiler/libVSC/drvi/gc_vsc_drvi_ep_io.o
SOURCE_OBJECTS += $(driver_root)/compiler/libVSC/drvi/gc_vsc_drvi_link.o
SOURCE_OBJECTS += $(driver_root)/compiler/libVSC/chip/gpu/gc_vsc_chip_state_programming.o
SOURCE_OBJECTS += $(driver_root)/compiler/libVSC/chip/gpu/gc_vsc_chip_uarch_caps.o
SOURCE_OBJECTS += $(driver_root)/compiler/libVSC/chip/gpu/gc_vsc_chip_mc_codec.o
SOURCE_OBJECTS += $(driver_root)/compiler/libVSC/chip/gpu/gc_vsc_chip_mc_dump.o
SOURCE_OBJECTS += $(driver_root)/compiler/libVSC/asm/gc_vsc_asm_al_codec.o
SOURCE_OBJECTS += $(driver_root)/compiler/libVSC/lib/gc_vsc_lib_gl_builtin.o
SOURCE_OBJECTS += $(driver_root)/compiler/libVSC/lib/gc_vsc_lib_gl_patch.o
SOURCE_OBJECTS += $(driver_root)/compiler/libVSC/lib/gc_vsc_lib_common.o
...
SOURCE_OBJECTS += $(driver_root)/compiler/libVSC/utils/io/gc_vsc_utils_io.o
...
SOURCE_OBJECTS += $(driver_root)/compiler/libVSC/vir/codegen/gc_vsc_vir_uniform_alloc.o
SOURCE_OBJECTS += $(driver_root)/compiler/libVSC/vir/codegen/gc_vsc_vir_mc.o
...
SOURCE_OBJECTS += $(driver_root)/compiler/libVSC/vir/ir/gc_vsc_vir_io.o
SOURCE_OBJECTS += $(driver_root)/compiler/libVSC/vir/ir/gc_vsc_vir_symbol_table.o
SOURCE_OBJECTS += $(driver_root)/compiler/libVSC/vir/ir/gc_vsc_vir_execute.o
SOURCE_OBJECTS += $(driver_root)/compiler/libVSC/vir/lower/gc_vsc_vir_hl_2_hl_expand.o
...
SOURCE_OBJECTS += $(driver_root)/compiler/libVSC/vir/linker/gc_vsc_vir_linker.o
...
SOURCE_OBJECTS += $(driver_root)/compiler/libVSC/vir/transform/gc_vsc_vir_misc_pass.o
...
SOURCE_OBJECTS += $(driver_root)/compiler/libVSC/vir/transform/gc_vsc_vir_loop.o
SOURCE_OBJECTS += $(driver_root)/compiler/libVSC/vir/transform/gc_vsc_vir_param_opts.o
SOURCE_OBJECTS += $(driver_root)/compiler/libVSC/vir/debugger/gc_vsc_vir_debugger.o
SOURCE_OBJECTS += $(driver_root)/compiler/libVSC/vir/debugger/gc_vsc_vir_emulator.o
SOURCE_OBJECTS += $(driver_root)/compiler/libVSC/debug/gc_vsc_debug.o
...
EXTRA_SRCVPATH += $(driver_root)/compiler/libVSC/chip/gpu
EXTRA_SRCVPATH += $(driver_root)/compiler/libVSC/drvi
EXTRA_SRCVPATH += $(driver_root)/compiler/libVSC/lib
...
EXTRA_SRCVPATH += $(driver_root)/compiler/libVSC/utils/io
...
EXTRA_SRCVPATH += $(driver_root)/compiler/libVSC/vir/linker
EXTRA_SRCVPATH += $(driver_root)/compiler/libVSC/vir/passmanager
EXTRA_SRCVPATH += $(driver_root)/compiler/libVSC/vir/transform
EXTRA_SRCVPATH += $(driver_root)/compiler/libVSC/vir/debugger
EXTRA_SRCVPATH += $(driver_root)/compiler/libVSC/debug
