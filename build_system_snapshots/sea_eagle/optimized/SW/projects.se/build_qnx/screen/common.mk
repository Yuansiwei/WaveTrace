...
define PINFO
PINFO DESCRIPTION="Vivante Screen Module"
endef

NAME=screen-$(HARDWARENAME)
...
SOURCE_OBJECTS += $(driver_root)/driver/qnx/screen/vivante.o
EXTRA_SRCVPATH += $(driver_root)/driver/qnx/screen
