...
EXTRA_INCVPATH += $(driver_root)/arch/libNNArchPerf/libNNArchPerf

ifeq ($(USE_VXC_BINARY),1)
EXTRA_INCVPATH += $(driver_root)/driver/khronos/libOpenVX/libkernel/libnngpu/$(GPU_CONFIG)
EXTRA_INCVPATH += $(driver_root)/driver/khronos/libOpenVX/libkernel/libnnvxc/$(GPU_CONFIG)
EXTRA_INCVPATH += $(driver_root)/driver/khronos/libOpenVX/libkernel/libovx12/$(GPU_CONFIG)
EXTRA_INCVPATH += $(driver_root)/driver/khronos/libOpenVX/libkernel/libovxgpu/$(GPU_CONFIG)
ifeq ($(TARGET32),1)
	CFLAGS += -DTARGET32
endif
endif
...
SOURCE_OBJECTS += $(driver_root)/driver/khronos/libOpenVX/driver/src/gc_vx_spinst.o
...
SOURCE_OBJECTS += $(driver_root)/driver/khronos/libOpenVX/driver/src/layers/gc_vx_layer_batch_gemm.o
SOURCE_OBJECTS += $(driver_root)/driver/khronos/libOpenVX/driver/src/layers/gc_vx_layer_conv3d.o
SOURCE_OBJECTS += $(driver_root)/driver/khronos/libOpenVX/driver/src/layers/gc_vx_layer_deconv3d.o
SOURCE_OBJECTS += $(driver_root)/driver/khronos/libOpenVX/driver/src/layers/gc_vx_layer_sp.o
...
SOURCE_OBJECTS += $(driver_root)/driver/khronos/libOpenVX/driver/src/gc_vx_multi_core.o
...
SOURCE_OBJECTS += $(driver_root)/driver/khronos/libOpenVX/driver/src/gc_vx_gpu_interface.o
...
SOURCE_OBJECTS += $(driver_root)/driver/khronos/libOpenVX/kernels/gc_vxk_hog.o
SOURCE_OBJECTS += $(driver_root)/driver/khronos/libOpenVX/kernels/gc_vxk_minmax.o
SOURCE_OBJECTS += $(driver_root)/driver/khronos/libOpenVX/kernels/gc_vxk_matchtemplate.o
SOURCE_OBJECTS += $(driver_root)/driver/khronos/libOpenVX/kernels/gc_vxk_lbp.o
...
LIBS += $(STATIC_LIBS)
ifeq ($(ORI_NNARCHPERF),1)
LDOPTS += -lCLC -lVSC -lGAL -lNNArchPerf
else
LDOPTS += -lCLC -lVSC -lGAL -lNNArchPerf -lArchModelSw
endif
...
# Turn off -Werror=format-nonliteral because of gcfVX_PrintData and gcfVX_PrintParseData.
# gcfVX_PrintData is unfixable without effort comparable with reimplementing printf.
# gcfVX_PrintParseData does some strange computed format string thing.
