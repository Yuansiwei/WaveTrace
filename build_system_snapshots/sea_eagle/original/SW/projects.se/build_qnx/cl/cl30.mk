...
# from libCL30 (trunk/driver/khronos/libCL30/makefile.linux)
SOURCE_OBJECTS += $(driver_root)/driver/khronos/libCL30/gc_cl.o
SOURCE_OBJECTS += $(driver_root)/driver/khronos/libCL30/gc_cl_log.o
SOURCE_OBJECTS += $(driver_root)/driver/khronos/libCL30/gc_cl_command.o
SOURCE_OBJECTS += $(driver_root)/driver/khronos/libCL30/gc_cl_context.o
SOURCE_OBJECTS += $(driver_root)/driver/khronos/libCL30/gc_cl_device.o
SOURCE_OBJECTS += $(driver_root)/driver/khronos/libCL30/gc_cl_enqueue.o
SOURCE_OBJECTS += $(driver_root)/driver/khronos/libCL30/gc_cl_event.o
SOURCE_OBJECTS += $(driver_root)/driver/khronos/libCL30/gc_cl_extension.o
SOURCE_OBJECTS += $(driver_root)/driver/khronos/libCL30/gc_cl_api.o
SOURCE_OBJECTS += $(driver_root)/driver/khronos/libCL30/gc_cl_chip.o
SOURCE_OBJECTS += $(driver_root)/driver/khronos/libCL30/gc_cl_kernel.o
SOURCE_OBJECTS += $(driver_root)/driver/khronos/libCL30/gc_cl_mem.o
SOURCE_OBJECTS += $(driver_root)/driver/khronos/libCL30/gc_cl_platform.o
SOURCE_OBJECTS += $(driver_root)/driver/khronos/libCL30/gc_cl_program.o
SOURCE_OBJECTS += $(driver_root)/driver/khronos/libCL30/gc_cl_profiler.o
SOURCE_OBJECTS += $(driver_root)/driver/khronos/libCL30/gc_cl_tracer.o
SOURCE_OBJECTS += $(driver_root)/driver/khronos/libCL30/gc_cl_sampler.o
SOURCE_OBJECTS += $(driver_root)/driver/khronos/libCL30/gc_cl_command_buffer.o
SOURCE_OBJECTS += $(driver_root)/driver/khronos/libCL30/gc_cl_resource.o
ifeq ($(ENABLE_CL_GL), 1)
SOURCE_OBJECTS += $(driver_root)/driver/khronos/libCL30/gc_cl_gl.o
endif

EXTRA_SRCVPATH += $(driver_root)/driver/khronos/libCL30
...
LDFLAGS += -Wl,--version-script=$(driver_root)/driver/khronos/libCL30/libOpenCL$(CL_SUFFIX).map
